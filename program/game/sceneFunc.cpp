...
void scenePlayCh1(float delta_time) {
	...
	if (!sceneInit) {
		...
		case 0:
			...
			strcpy(enemyData, "enemyControlDataCh00.csv");
		...
		case 1:
			...
			strcpy(effect1, "graphics/Back/wave.png");
			strcpy(effect2, "graphics/Back/Cloud2.png");
			strcpy(enemyData, "enemyControlDataCh1.csv");
		...
		// 選択肢に応じてシーンマネージャーインスタンス化
		sceneManagerCh1 = new SceneManagerCh1(choiceChapter, backName, effect1, effect2, enemyData);
